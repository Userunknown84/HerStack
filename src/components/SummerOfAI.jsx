const features = [
  {
    ...
    description: 'Work on open source AI tools that girls across India actually use. Your name on real commits.',
  },
  {
    icon: '👩‍💼',
    title: '1:1 Mentorship',
    description: 'Get paired with a woman working in AI. Weekly check-ins, career guidance, real talk.',
  },
  {
    icon: '🏆',
    title: 'Certificate & Recognition',
    description: "A credential that shows what you built — not just what you watched. Goes straight on your resume.",
  },
  {
    icon: '🌐',
    title: 'Pan-India Community',
    description: 'Connect with girls building AI from every state. Your future co-founders are here.',
  },
]
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
        {/* Left */}
        <div>
          <div className="text-xs font-semibold uppercase tracking-widest mb-4" style={{ color: 'rgba(255,255,255,0.6)' }}>
            Coming 2026
          </div>
          <h2
            className="font-display font-bold leading-tight mb-5"
            style={{ fontSize: 'clamp(2rem, 4vw, 3rem)', letterSpacing: '-0.03em', color: 'white' }}
          >
            HerStack<br />Summer of AI
          </h2>
